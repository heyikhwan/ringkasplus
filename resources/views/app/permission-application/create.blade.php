<x-app-layout :title=$title>
    <form class="form w-100" action="{{ route($permission_name . '.store') }}" method="post" id="form" onsubmit="submitModalDataTable(this); return false;">
        @csrf
        ...
        <div class="card">
            ...
            <div class="card-body">
                <x-alert alertType="info" title="Perhatian">
                    Hak akses yang <strong>tidak diaktifkan</strong> berarti fitur tersebut <strong>tidak akan
                        muncul</strong> untuk pengguna.
                </x-alert>
